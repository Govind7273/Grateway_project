    ...
    return(
        <div className="relative flex flex-col lg:flex-row items-center justify-center py-[1rem] sm:py-[2rem] md:py-[5rem] lg:translate-x-40">
            ...
            <div className=" flex items-center justify-center ">
                <div className=" relative flex flex-col items-start justify-center text-left  bg-[#59e7fa] p-6 md:-translate-y-1/2 lg:translate-y-0 md:-mb-[10rem] lg:mb-0 lg:-translate-x-1/2 cursor-pointer hover:scale-105 rounded-xl">
