            ...
            <div className=" flex items-center justify-center ">
                <div className=" relative flex flex-col items-start justify-center text-left  bg-[#59e7fa] p-6 md:-translate-y-1/2 lg:translate-y-0 md:-mb-[10rem] lg:mb-0 lg:-translate-x-1/2 cursor-pointer hover:scale-105 transition-all ease-linear rounded-xl">
                    ...
                    <div className="relative flex group">
                        <Link to={"/ContactUs"}>
                            <button className="relative animate-bounce focus:animate-none hover:animate-none inline-flex text-sm font-medium bg-blue-900 hover:bg-blue-800 mt-3 lg:mt-6 px-2 py-1 sm:px-4 sm:py-2 rounded-full tracking-wide text-white border border-fuchsia-800">
