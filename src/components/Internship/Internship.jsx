  ...
  return (
    <>
      ...
      <main className="main__screen bg-gray-300 relative overflow-hidden">
          ...
          >
            ...
            >
              <Link
                smooth
                to={"#Cards"}
                className="items-start w-fit bg-cyan-300 px-3 py-1 md:px-4 md:py-2 rounded-xl font-bold text-slate-800 hover:bg-white hover:text-cyan-700 transition-all 0.2 ease-out capitalize"
              >
              ...
              <div className="[ lg:flex lg:items-center ] [ fancy-corners fancy-corners--large fancy-corners--top-left fancy-corners--bottom-right ]">
                ...
                <div className="py-8 sm:px-12 px-3 text-center">
                  <div className="leading-relaxed">
                    ...
                    >
                      "Providing customized growth opportunities through
                      mentorship, training programs and pathways for
                      advancement. We empower our team to grow professionally,
                      fostering innovation and excellence in software
                      solutions."
                    </motion.p>
                  </div>
                </div>
        ...
        <section
          id="Cards"
          className="flex px-4 justify-evenly flex-wrap py-28 gap-8 bg-slate-50"
        >
          {IntershipDetails.map((detail) => {
            return (
              <motion.div
                ...
                key={detail.id}
                className="sm:w-[500px] w-auto flex flex-col rounded-xl border-dashed shadow-lg shadow-slate-300 items-center"
              >
                ...
                <div className="apply_btn w-full pb-3 px-3 flex justify-end flex-col sm:flex-row gap-4">
                  ...
                  <Link
                    to={`/internshipDetails/${detail.id}`}
                    className="rounded-xl items-start w-fit hover:bg-cyan-300 px-3 py-1 md:px-4 md:py-2 border boder-[#4c9ddc] font-bold hover:text-slate-800 bg-white text-cyan-700 transition-all 0.2 ease-out capitalize "
                  >
                    View Details
                  </Link>
                </div>
