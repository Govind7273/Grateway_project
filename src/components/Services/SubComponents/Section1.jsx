...
const Section1 = ({ obj }) => {
  ...
  return (
    <div id="section2" className={parentBg}>
      <div className={subParentBG}>
        ...
        <div className="col-span-1 rounded-xl flex shadow-black shadow-lg justify-center items-center">
          ...
          <motion.div
            ...
            className="text-blue-900 flex absolute z-0 left-0 top-[30px] text-[100px]">
            <TbRectangle />
          </motion.div>
        </div>
        ...
        <div className="flex justify-end">
          ...
          <div className="col-span-1 py-6 md:py-0 w-full grid grid-cols-1 justify-center items-center">
            ...
            <motion.p
              ...
              className="text-Paragraph font-navlistFont md:text-start text-center font-semibold">
              {obj.content.message}
            </motion.p>
            <motion.div
