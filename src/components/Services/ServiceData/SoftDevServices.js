...
export const SoftDevServices =
{
  ...
  cards: [
    ...
    },
    {
      ...
      description:
        "Agile development methodologies prioritize iterative, collaborative, and adaptive processes, fostering enhanced customer satisfaction and ensuring agile responses to dynamically evolving project requirements, thereby promoting effective adaptation and continuous improvement.",
    },
  ],
  third: {
...
export const CloudServices =
{
  ...
  cards: [
    ...
    },
    {
      ...
      description:
        "We offer a robust backup strategy for cloud storage, including regular automated data backups, redundancy for high availability, strong encryption, and periodic integrity testing to ensure data security and reliability.",
    },
  ],
  third: {
  ...
  cards: [
    {
      ...
      description:
        "Continuous Integration and Continuous Delivery (CI/CD) is a software development practice that integrates code changes frequently, automates testing, and facilitates swift application deployment. This ensures rapid, reliable, and continuous delivery of high-quality software.",
    },
    {
      imageUrl: DevopsInfraImage,
      heading: "Infrastructure as Code (IaC)",
      description:
        "We specialize in providing comprehensive Infrastructure as Code (IaC) services, enabling automated provisioning and efficient management of cloud infrastructure through code. This approach enhances scalability, ensures consistency across IT operations, and optimizes deployment efficiency.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Our expertise lies in orchestration services, utilizing Kubernetes to automate the deployment, scaling, and management of containerized applications. We specialize in optimizing resource utilization, enhancing scalability, and ensuring high availability in dynamic environments.",
    },
  ],
  third: {
