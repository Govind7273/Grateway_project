      ...
      <section className="bg-slate-200">
        <div className="flex items-center justify-center">
          <div className="w-[100%] px-4 py-4 pt-6 sm:pt-0">
            ...
            <h2 className="text-MainHeading capitalize md:text-MainHeading font-bold cursor-pointer text-center">
              Why to choose us for premium {obj.titleName} Services
            </h2>
            <p className="text-Paragraph font-semibold cursor-pointer py-2 text-center">
              {obj.description}
            </p>
