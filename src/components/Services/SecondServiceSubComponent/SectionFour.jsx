          ...
          <div class="shadow rounded-xl">
            <div class="grid overflow-hidden text-white shadow-xl md:grid-cols-2 bg-gradient-to-tl from-blue-800 to-blue-400 rounded-xl">
              <aside class="p-8 space-y-4 md:p-16">
                ...
                <p class="text-Paragraph-sm md:text-Paragraph text-white">
                  <span className="text-white">{obj.desc}</span>
                </p>

                <div className="pt-4">
                  <a href="./ContactUs" class="items-start w-fit bg-cyan-300 px-3 py-1 border border-cyan-300 md:px-4 md:py-2 rounded-xl font-bold text-slate-800 hover:bg-white hover:text-cyan-600 transition-all 0.2 ease-out hover:border">
                    Connect with us
                  </a>
                </div>
              </aside>
