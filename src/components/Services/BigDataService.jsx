        ...
        <div className="w-[100%] relative flex justify-center items-center ">
          ...
          <div className=" absolute z-10 w-[80%] h-[100vh] gap-0 flex justify-center items-center flex-col ">
            ...
            <p className="text-white text-xl p-4">
              "Big data analytics involves the systematic examination of large
              and varied datasets using advanced computational methods. Through
              this process, organizations derive valuable insights, enabling
        ...
        <div className="w-[100%] grid md:grid-cols-2  grid-cols-1  bg-blue-900/35 ">
          <div className="text-white relative flex justify-center gap-4 p-8 flex-col">
            ...
            <p>
              ...
              and merging of diverse datasets from multiple sources. This
              process involves acquiring, organizing, and standardizing data to
              ensure consistency and accuracy. By integrating disparate data
              sets, organizations can gain a comprehensive understanding of
              their operations, customers, and market trends, facilitating
        ...
        <div className="w-[100%] bg-blue-900/25 flex flex-col items-center text-white pb-16 pt-14">
          ...
          <div className="w-[90%] flex flex-col items-center p-8 gap-2">
            ...
            <p className="text-slate-300 text-lg">
              ...
              leadership. Distinctively transform tactical methods of
              empowerment.
            </p>
          </div>
          ...
          <div className="w-[80%] grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 justify-items-center items-center gap-x-6 gap-y-10 pt-8">
            {card.map((item) => (
              <div
                key={item.title}
                className="flex flex-col items-center hover:cursor-pointer gap-2"
              >
