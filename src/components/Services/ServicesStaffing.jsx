...
const ServicesStaffing = ({ Meta_Data }) => {
  ...
  return (
    <>
      ...
      <section id='section2' className="w-[100vw] relative overflow-x-hidden pt-0">
        {/* First Section */}
        <div className="py-20 sm:py-32 bg-gradient-to-r">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-7xl py-1 lg:mx-0  w-[100%] ">
              <h2 className="text-4xl lg:text-5xl font-bold text-cyan-500 sm:text-xl justify-center lg:items-center sm:mr-64 sm:ml-3 lg:pl-56 lg:ml-52 ">
                What is IT staffing ?
              </h2>
            </div>
            <div className="mx-auto mt-1 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-100 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              <article className="flex max-w-xl flex-col items-start justify-between sm:mb-1">
                <div className="group relative ">
                  <p className="mt-0 text-blue-500 text-justify font-bold leading-6 md:text-xl text-md drop-shadow-lg hover:animate-pulse">
                    "Transform your IT landscape with our bespoke staffing
                    solutions."
                  </p>
                </div>
                <div className="relative mt-1 flex items-center gap-x-4 shadow hover: ">
                  <div className="text-sm leading-6 mb-10 hover:shadow-2xl mt-1 sm:mt-1 sm:mb-1 shadow-lg  shadow-indigo-300 hover:bg-white ">
                    <img
                      src="https://dis-blog.thalesgroup.com/wp-content/uploads/2018/10/IoT-in-2030-part-3-1140x760.jpg"
                      alt=""
                      className=""
                    ></img>
                  </div>
              ...
              <article className="flex max-w-xl flex-col items-start justify-between">
                <div className="group relative sm:mt-0 sm:pt">
                  <p className="mt-0 text-blue-500 text-justify font-bold leading-6 md:text-xl text-md drop-shadow-lg hover:animate-pulse">
                    "We meticulously match your needs with top-notch talent,
                ...
                <div className="relative mt-1 flex items-center gap-x-4">
                  <div className="text-sm leading-6 mb-10 hover:shadow-2xl mt-1 sm:mt-1 sm:mb-1 shadow-lg  shadow-indigo-300">
                    <img
                      src="/src/components/Services/Images/ServiceSupport/ProjectExecution.jpg"
                      alt=""
                      className="w-  h-"
                    ></img>
                  </div>
              ...
              <article className="flex max-w-xl flex-col items-start justify-between">
                <div className="group relative">
                  <p className="mt-0 text-blue-500 text-justify font-bold leading-6 md:text-xl text-md drop-shadow-lg hover:animate-pulse">
                    "Let us elevate your workforce, driving innovation and
                    success."
                  </p>
                </div>
                <div className="relative mt-1 flex items-center gap-x-4">
                  <div className="text-sm leading-6 mb-10 hover:shadow-2xl mt-1 sm:mt-1 sm:mb-1 shadow-lg shadow-indigo-300">
                    <img
                      src="/src/components/Services/Images/ServiceSupport/ContractDeal.jpg"
                      alt=""
                      className="w-  h-"
                    ></img>
                  </div>
        ...
        <div className="bg-gray-100  min-h-screen py-20">
          <div className="container mx-auto">
            <h1 className="text-[2rem] text-blue-500 text-center font-bold font-headingFont mb-8 capitalize underline">
