        ...
        <div className="sm:grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-12 md:gap-12">
          ...
          <div
            ...
            <div className="py-4 md:px-6 px-2">
              <img src={vision} alt="" className="rounded-2xl h-12 w-12 mb-4 bg-white" />
          ...
          <div
            ...
            <div className="py-4 md:px-6 px-2">
              <img src={mission} alt="" className="rounded-2xl h-12 w-12 mb-4" />
          ...
          <div
            ...
            <div className="py-4 md:px-6 px-2">
              <img src={value} alt="" className="rounded-2xl h-12 w-12 mb-4 bg-white" />
