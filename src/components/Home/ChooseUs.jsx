            ...
            <motion.div className="md:absolute md:w-[80%] w-full flex-row py-4">
                ...
                <div className=''>
                    <motion.ul
                        ...
                        <li className="md:px-2 hover:text-white md:py-2 border-b border-gray-400 w-full rounded-t-lg hover:bg-[#2c3493] list-disc md:text-nowrap">
                        ...
                        <li className="md:px-2 hover:text-white md:py-2 border-b border-gray-400 w-full hover:bg-[#2c3493]">
